...
export const getAccounts = () => ({
  text: `SELECT a.createdon AS createdOn, a.accountnumber AS accountNumber, 
    u.email AS ownerEmail, a.type AS type, a.status AS status , a.balance AS balance 
    FROM accounts a 
    INNER JOIN users u ON u.id = a.owner`,
  values: [],
});

/**
 * @name getAccountByStatus
 * @description - gets all accounts by status
 * @param {string} status
 * @returns the query
 */
 ...
 * @description - gets all accounts for a specific owner
 * @param {int} ownerId
 * @returns the query
 */
...
/**
 * @name getUserByEmail
 * @description - gets a single user by email
 * @param {string} email
 * @returns the query
 */
...
export const getAccountTransactions = (accountNumber) => ({
  text: `SELECT id AS transactionId, createdon AS createdOn, type, 
    accountnumber AS accountNumber, oldbalance AS oldBalance, newbalance AS newBalance 
